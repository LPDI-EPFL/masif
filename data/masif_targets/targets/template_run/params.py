...
# Seed locations
params['top_seed_dir'] = os.path.join(params['masif_root'], 'data/masif_ppi_search/')
params['seed_surf_dir'] = os.path.join(params['top_seed_dir'], masif_opts['ply_chain_dir'])
params['seed_iface_dir'] = os.path.join(params['masif_root'],'data/masif_site',masif_opts['site']['out_pred_dir'])

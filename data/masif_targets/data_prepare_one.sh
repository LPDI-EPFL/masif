...
python $masif_source/data_preparation/00-pdb_download.py $PDB_ID
...
python3 $masif_source/data_preparation/04b-convert_mat2geo_dists.py site $1
python3 $masif_source/data_preparation/04b-convert_mat2geo_dists.py ppi_search $1

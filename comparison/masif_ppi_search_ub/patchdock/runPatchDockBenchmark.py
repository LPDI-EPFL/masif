...
precomp_dir = '../../../data/masif_ppi_search_ub/data_preparation/04b-precomputation_12A/'
...
for target_pdb in benchmark_pdbs_target:
    ...
    target_struct = parser.get_structure('{}_{}'.format(pdbid,t_chain), os.path.join(struct_dir,'{}_{}.pdb'.format(pdbid,t_chain)))
    ...
    for source_pdb in benchmark_pdbs_source:
        ...
        process = subprocess.Popen([pd_bin, 'params.txt', pd_out_fn], cwd=outdir, stdout=subprocess.PIPE, stderr=subprocess.PIPE) 

...
learning_obj = MaSIF_site(params['max_distance'], n_thetas=4, n_rhos=3, n_rotations=4, idx_gpu = '/gpu:0', feat_mask=params['feat_mask'], n_conv_layers=params['n_conv_layers'] )

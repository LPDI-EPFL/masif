...
def extractPDB(infilename, outfilename, chain_ids=None, includeWaters=False,\
                            invert=False):
    ...
    for chain in model:
        if chain_ids == None or \
                (chain.get_id() in chain_ids and not invert) or \
                invert == True:

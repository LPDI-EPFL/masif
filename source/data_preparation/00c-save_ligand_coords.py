...
try:
    structure = PDB(os.path.join(masif_opts['ligand']['assembly_dir'],'{}.pdb'.format(pdb_id)))
except:
...
np.save(os.path.join(masif_opts['ligand']['ligand_coords_dir'],'{}_ligand_types.npy'.format(pdb_id)),structure_ligands_type)
np.save(os.path.join(masif_opts['ligand']['ligand_coords_dir'],'{}_ligand_coords.npy'.format(pdb_id)),structure_ligands_coords)

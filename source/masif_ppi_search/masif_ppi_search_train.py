...
pos_training_idx = np.load(params['cache_dir']+'/pos_training_idx.npy')
pos_val_idx = np.load(params['cache_dir']+'/pos_val_idx.npy')
pos_test_idx = np.load(params['cache_dir']+'/pos_test_idx.npy')
...
neg_training_idx = np.load(params['cache_dir']+'/neg_training_idx.npy')
neg_val_idx = np.load(params['cache_dir']+'/neg_val_idx.npy')
neg_test_idx = np.load(params['cache_dir']+'/neg_test_idx.npy')
...
#neg_names = np.load(params['cache_dir']+'/neg_names.npy')
...
train_ppi_search(learning_obj, params,

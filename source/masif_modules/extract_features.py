...
def extract_features(list_desc, list_coords):
    ...
    if len(list_hphob) > 0:
        return list_rho_wrt_center, list_theta_wrt_center, list_isc, list_normals_proj, norm_list_electrostatics, list_hbond, list_hphob
    else:
        return list_rho_wrt_center, list_theta_wrt_center, list_isc, list_normals_proj, norm_list_electrostatics, list_hbond
